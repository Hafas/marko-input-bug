...
$_mod.installed("marko-input-bug$1.0.0", "marko", "4.6.0");
$_mod.main("/marko$4.6.0/src/runtime/vdom", "");
$_mod.main("/marko$4.6.0/src", "");
$_mod.remap("/marko$4.6.0/src/index", "/marko$4.6.0/src/index-browser");
$_mod.def("/marko$4.6.0/src/runtime/createOut", function(require, exports, module, __filename, __dirname) { var actualCreateOut;
...
$_mod.main("/marko$4.6.0/src/loader", "");
$_mod.remap("/marko$4.6.0/src/loader/index", "/marko$4.6.0/src/loader/index-browser");
$_mod.remap("/marko$4.6.0/src/loader/index-browser", "/marko$4.6.0/src/loader/index-browser-dynamic");
$_mod.def("/marko$4.6.0/src/loader/index-browser-dynamic", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.def("/marko$4.6.0/src/index-browser", function(require, exports, module, __filename, __dirname) { 'use strict';
exports.createOut = require('/marko$4.6.0/src/runtime/createOut'/*'./runtime/createOut'*/);
exports.load = require('/marko$4.6.0/src/loader/index-browser-dynamic'/*'./loader'*/);
});
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/VNode", function(require, exports, module, __filename, __dirname) { /* jshint newcap:false */
function VNode() {}
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/VComment", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.6.0/src/runtime/vdom/VNode'/*'./VNode'*/);
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/VDocumentFragment", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.6.0/src/runtime/vdom/VNode'/*'./VNode'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/VElement", function(require, exports, module, __filename, __dirname) { /* jshint newcap:false */
var VNode = require('/marko$4.6.0/src/runtime/vdom/VNode'/*'./VNode'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/VText", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.6.0/src/runtime/vdom/VNode'/*'./VNode'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/VComponent", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.6.0/src/runtime/vdom/VNode'/*'./VNode'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/vdom", function(require, exports, module, __filename, __dirname) { var VNode = require('/marko$4.6.0/src/runtime/vdom/VNode'/*'./VNode'*/);
var VComment = require('/marko$4.6.0/src/runtime/vdom/VComment'/*'./VComment'*/);
var VDocumentFragment = require('/marko$4.6.0/src/runtime/vdom/VDocumentFragment'/*'./VDocumentFragment'*/);
var VElement = require('/marko$4.6.0/src/runtime/vdom/VElement'/*'./VElement'*/);
var VText = require('/marko$4.6.0/src/runtime/vdom/VText'/*'./VText'*/);
var VComponent = require('/marko$4.6.0/src/runtime/vdom/VComponent'/*'./VComponent'*/);
...
$_mod.remap("/marko$4.6.0/src/components/util", "/marko$4.6.0/src/components/util-browser");
$_mod.remap("/marko$4.6.0/src/components/init-components", "/marko$4.6.0/src/components/init-components-browser");
...
$_mod.def("/marko$4.6.0/src/components/bubble", function(require, exports, module, __filename, __dirname) { module.exports = [
    /* Mouse Events */
    'click',
    'dblclick',
    'mousedown',
...
$_mod.def("/marko$4.6.0/src/components/event-delegation", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.6.0/src/components/util-browser'/*'./util'*/);
...
function attachBubbleEventListeners(doc) {
    ...
    require('/marko$4.6.0/src/components/bubble'/*'./bubble'*/).forEach(function addBubbleHandler(eventType) {
...
$_mod.def("/marko$4.6.0/src/components/KeySequence", function(require, exports, module, __filename, __dirname) {  function KeySequence() {
    this.___lookup = {};
}
...
$_mod.def("/marko$4.6.0/src/components/ComponentDef", function(require, exports, module, __filename, __dirname) { 'use strict';
var repeatedRegExp = /\[\]$/;
var componentUtil = require('/marko$4.6.0/src/components/util-browser'/*'./util'*/);
var attachBubblingEvent = componentUtil.___attachBubblingEvent;
var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
var KeySequence = require('/marko$4.6.0/src/components/KeySequence'/*'./KeySequence'*/);
...
$_mod.remap("/marko$4.6.0/src/components/registry", "/marko$4.6.0/src/components/registry-browser");
$_mod.remap("/marko$4.6.0/src/components/loadComponent", "/marko$4.6.0/src/components/loadComponent-dynamic");
$_mod.def("/marko$4.6.0/src/components/loadComponent-dynamic", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.def("/marko$4.6.0/src/components/State", function(require, exports, module, __filename, __dirname) { var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
...
$_mod.installed("marko$4.6.0", "complain", "1.2.0");
...
$_mod.def("/marko$4.6.0/src/components/GlobalComponentsContext", function(require, exports, module, __filename, __dirname) { var nextComponentIdProvider = require('/marko$4.6.0/src/components/util-browser'/*'./util'*/).___nextComponentIdProvider;
var KeySequence = require('/marko$4.6.0/src/components/KeySequence'/*'./KeySequence'*/);
...
$_mod.def("/marko$4.6.0/src/components/ComponentsContext", function(require, exports, module, __filename, __dirname) { 'use strict';
var GlobalComponentsContext = require('/marko$4.6.0/src/components/GlobalComponentsContext'/*'./GlobalComponentsContext'*/);
...
$_mod.remap("/marko$4.6.0/src/runtime/nextTick", "/marko$4.6.0/src/runtime/nextTick-browser");
$_mod.def("/marko$4.6.0/src/runtime/nextTick-browser", function(require, exports, module, __filename, __dirname) { /* globals window */
...
$_mod.def("/marko$4.6.0/src/components/update-manager", function(require, exports, module, __filename, __dirname) { 'use strict';

var updatesScheduled = false;
var batchStack = []; // A stack of batched updates
var unbatchedQueue = []; // Used for scheduled batched updates

var nextTick = require('/marko$4.6.0/src/runtime/nextTick-browser'/*'../runtime/nextTick'*/);
...
$_mod.main("/marko$4.6.0/src/morphdom", "");
$_mod.def("/marko$4.6.0/src/morphdom/specialElHandlers", function(require, exports, module, __filename, __dirname) { function syncBooleanAttrProp(fromEl, toEl, name) {
...
$_mod.def("/marko$4.6.0/src/morphdom/index", function(require, exports, module, __filename, __dirname) { 'use strict';
var specialElHandlers = require('/marko$4.6.0/src/morphdom/specialElHandlers'/*'./specialElHandlers'*/);
var componentsUtil = require('/marko$4.6.0/src/components/util-browser'/*'../components/util'*/);
var existingComponentLookup = componentsUtil.___componentLookup;
var destroyNodeRecursive = componentsUtil.___destroyNodeRecursive;
var VElement = require('/marko$4.6.0/src/runtime/vdom/vdom'/*'../runtime/vdom/vdom'*/).___VElement;
var virtualizeElement =  VElement.___virtualize;
var morphAttrs = VElement.___morphAttrs;
var eventDelegation = require('/marko$4.6.0/src/components/event-delegation'/*'../components/event-delegation'*/);
...
$_mod.def("/marko$4.6.0/src/components/Component", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var complain = 'MARKO_DEBUG' && require('/complain$1.2.0/index'/*'complain'*/);

var domInsert = require('/marko$4.6.0/src/runtime/dom-insert'/*'../runtime/dom-insert'*/);
var defaultCreateOut = require('/marko$4.6.0/src/runtime/createOut'/*'../runtime/createOut'*/);
var getComponentsContext = require('/marko$4.6.0/src/components/ComponentsContext'/*'./ComponentsContext'*/).___getComponentsContext;
var componentsUtil = require('/marko$4.6.0/src/components/util-browser'/*'./util'*/);
var componentLookup = componentsUtil.___componentLookup;
...
var RenderResult = require('/marko$4.6.0/src/runtime/RenderResult'/*'../runtime/RenderResult'*/);
var SubscriptionTracker = require('/listener-tracker$2.0.0/lib/listener-tracker'/*'listener-tracker'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
var updateManager = require('/marko$4.6.0/src/components/update-manager'/*'./update-manager'*/);
var morphdom = require('/marko$4.6.0/src/morphdom/index'/*'../morphdom'*/);
var eventDelegation = require('/marko$4.6.0/src/components/event-delegation'/*'./event-delegation'*/);
...
$_mod.def("/marko$4.6.0/src/components/defineComponent", function(require, exports, module, __filename, __dirname) { 'use strict';
/* jshint newcap:false */

var BaseState = require('/marko$4.6.0/src/components/State'/*'./State'*/);
var BaseComponent = require('/marko$4.6.0/src/components/Component'/*'./Component'*/);
var inherit = require('/raptor-util$3.2.0/inherit'/*'raptor-util/inherit'*/);
...
$_mod.def("/marko$4.6.0/src/components/registry-browser", function(require, exports, module, __filename, __dirname) { var loadComponent = require('/marko$4.6.0/src/components/loadComponent-dynamic'/*'./loadComponent'*/);
var defineComponent = require('/marko$4.6.0/src/components/defineComponent'/*'./defineComponent'*/);
...
$_mod.def("/marko$4.6.0/src/components/init-components-browser", function(require, exports, module, __filename, __dirname) { 'use strict';
...
var componentsUtil = require('/marko$4.6.0/src/components/util-browser'/*'./util'*/);
var componentLookup = componentsUtil.___componentLookup;
var ComponentDef = require('/marko$4.6.0/src/components/ComponentDef'/*'./ComponentDef'*/);
var registry = require('/marko$4.6.0/src/components/registry-browser'/*'./registry'*/);
...
$_mod.def("/marko$4.6.0/src/components/boot", function(require, exports, module, __filename, __dirname) { require('/marko$4.6.0/src/components/init-components-browser'/*'./init-components'*/).___initServerRendered();
});
$_mod.run("/marko$4.6.0/src/components/boot");
$_mod.def("/marko$4.6.0/src/components/util-browser", function(require, exports, module, __filename, __dirname) { 
...
$_mod.def("/marko$4.6.0/src/runtime/dom-insert", function(require, exports, module, __filename, __dirname) { var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
var componentsUtil = require('/marko$4.6.0/src/components/util-browser'/*'../components/util'*/);
...
$_mod.def("/marko$4.6.0/src/runtime/RenderResult", function(require, exports, module, __filename, __dirname) { var domInsert = require('/marko$4.6.0/src/runtime/dom-insert'/*'./dom-insert'*/);
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/AsyncVDOMBuilder", function(require, exports, module, __filename, __dirname) { var EventEmitter = require('/events-light$1.0.5/src/index'/*'events-light'*/);
var vdom = require('/marko$4.6.0/src/runtime/vdom/vdom'/*'./vdom'*/);
...
var RenderResult = require('/marko$4.6.0/src/runtime/RenderResult'/*'../RenderResult'*/);
...
$_mod.def("/marko$4.6.0/src/runtime/renderable", function(require, exports, module, __filename, __dirname) { var defaultCreateOut = require('/marko$4.6.0/src/runtime/createOut'/*'./createOut'*/);
var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/index", function(require, exports, module, __filename, __dirname) { 'use strict';
require('/marko$4.6.0/src/index-browser'/*'../../'*/);

// helpers provide a core set of various utility methods
// that are available in every template
var AsyncVDOMBuilder = require('/marko$4.6.0/src/runtime/vdom/AsyncVDOMBuilder'/*'./AsyncVDOMBuilder'*/);
var makeRenderable = require('/marko$4.6.0/src/runtime/renderable'/*'../renderable'*/);
...
require('/marko$4.6.0/src/runtime/createOut'/*'../createOut'*/).___setCreateOut(createOut);

});
$_mod.def("/marko$4.6.0/src/vdom", function(require, exports, module, __filename, __dirname) { module.exports = require('/marko$4.6.0/src/runtime/vdom/index'/*'./runtime/vdom'*/);

});
$_mod.remap("/marko$4.6.0/src/components/helpers", "/marko$4.6.0/src/components/helpers-browser");
$_mod.main("/marko$4.6.0/src/components", "");
$_mod.remap("/marko$4.6.0/src/components/index", "/marko$4.6.0/src/components/index-browser");
$_mod.def("/marko$4.6.0/src/components/index-browser", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.6.0/src/components/util-browser'/*'./util'*/);
var initComponents = require('/marko$4.6.0/src/components/init-components-browser'/*'./init-components'*/);

require('/marko$4.6.0/src/components/ComponentsContext'/*'./ComponentsContext'*/).___initClientRendered = initComponents.___initClientRendered;

exports.getComponentForEl = componentsUtil.___getComponentForEl;
exports.init = initComponents.___initServerRendered;

});
$_mod.remap("/marko$4.6.0/src/components/beginComponent", "/marko$4.6.0/src/components/beginComponent-browser");
$_mod.def("/marko$4.6.0/src/components/beginComponent-browser", function(require, exports, module, __filename, __dirname) { var ComponentDef = require('/marko$4.6.0/src/components/ComponentDef'/*'./ComponentDef'*/);
...
$_mod.remap("/marko$4.6.0/src/components/endComponent", "/marko$4.6.0/src/components/endComponent-browser");
$_mod.def("/marko$4.6.0/src/components/endComponent-browser", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.def("/marko$4.6.0/src/components/renderer", function(require, exports, module, __filename, __dirname) { var componentsUtil = require('/marko$4.6.0/src/components/util-browser'/*'./util'*/);
var componentLookup = componentsUtil.___componentLookup;
var emitLifecycleEvent = componentsUtil.___emitLifecycleEvent;

var ComponentsContext = require('/marko$4.6.0/src/components/ComponentsContext'/*'./ComponentsContext'*/);
...
var beginComponent = require('/marko$4.6.0/src/components/beginComponent-browser'/*'./beginComponent'*/);
var endComponent = require('/marko$4.6.0/src/components/endComponent-browser'/*'./endComponent'*/);
...
$_mod.def("/marko$4.6.0/src/components/helpers-browser", function(require, exports, module, __filename, __dirname) { require('/marko$4.6.0/src/components/index-browser'/*'./'*/);

exports.c = require('/marko$4.6.0/src/components/defineComponent'/*'./defineComponent'*/); // Referenced by compiled templates
exports.r = require('/marko$4.6.0/src/components/renderer'/*'./renderer'*/); // Referenced by compiled templates
exports.rc = require('/marko$4.6.0/src/components/registry-browser'/*'./registry'*/).___register;  // Referenced by compiled templates

});
$_mod.def("/marko-input-bug$1.0.0/src/not-ok-example/component", function(require, exports, module, __filename, __dirname) { module.exports = class {
  onCreate () {
    this.state = {
      text: ""
    };
...
$_mod.def("/marko$4.6.0/src/runtime/helpers", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.def("/marko$4.6.0/src/runtime/vdom/helpers", function(require, exports, module, __filename, __dirname) { 'use strict';

var vdom = require('/marko$4.6.0/src/runtime/vdom/vdom'/*'./vdom'*/);
var VElement = vdom.___VElement;
var VText = vdom.___VText;

var commonHelpers = require('/marko$4.6.0/src/runtime/helpers'/*'../helpers'*/);
var extend = require('/raptor-util$3.2.0/extend'/*'raptor-util/extend'*/);
...
$_mod.def("/marko$4.6.0/src/taglibs/core/include-tag", function(require, exports, module, __filename, __dirname) { 
...
$_mod.def("/marko-input-bug$1.0.0/src/not-ok-example/layout.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.6.0 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.6.0/src/vdom'/*"marko/src/vdom"*/).t(),
    components_helpers = require('/marko$4.6.0/src/components/helpers-browser'/*"marko/src/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/marko-input-bug$1.0.0/src/not-ok-example/layout.marko", function() {
      return module.exports;
    }),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    marko_helpers = require('/marko$4.6.0/src/runtime/vdom/helpers'/*"marko/src/runtime/vdom/helpers"*/),
    marko_loadTag = marko_helpers.t,
    include_tag = marko_loadTag(require('/marko$4.6.0/src/taglibs/core/include-tag'/*"marko/src/taglibs/core/include-tag"*/));
...
$_mod.def("/marko-input-bug$1.0.0/src/not-ok-example/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.6.0 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require('/marko$4.6.0/src/vdom'/*"marko/src/vdom"*/).t(),
    components_helpers = require('/marko$4.6.0/src/components/helpers-browser'/*"marko/src/components/helpers"*/),
    marko_registerComponent = components_helpers.rc,
    marko_componentType = marko_registerComponent("/marko-input-bug$1.0.0/src/not-ok-example/index.marko", function() {
      return module.exports;
    }),
    marko_component = require('/marko-input-bug$1.0.0/src/not-ok-example/component'/*"./component"*/),
    marko_renderer = components_helpers.r,
    marko_defineComponent = components_helpers.c,
    layout_template = require('/marko-input-bug$1.0.0/src/not-ok-example/layout.marko'/*"./layout.marko"*/),
    marko_helpers = require('/marko$4.6.0/src/runtime/vdom/helpers'/*"marko/src/runtime/vdom/helpers"*/),
    marko_loadTag = marko_helpers.t,
    include_tag = marko_loadTag(require('/marko$4.6.0/src/taglibs/core/include-tag'/*"marko/src/taglibs/core/include-tag"*/));
  ...
  include_tag({
      ...
      renderBody: function renderBody(out) {
        out.e("INPUT", {
            ...
            oninput: __component.d("handleInput")
          });

        out.e("SPAN", null, "2", component, 1)
          .t(state.text);
      }
    }, out, __component, "0");
}
...
$_mod.def("/marko-input-bug$1.0.0/src/not-ok-example/client", function(require, exports, module, __filename, __dirname) { const example = require('/marko-input-bug$1.0.0/src/not-ok-example/index.marko'/*"./index"*/);

example.renderSync().appendTo(document.body);

});
$_mod.run("/marko-input-bug$1.0.0/src/not-ok-example/client");