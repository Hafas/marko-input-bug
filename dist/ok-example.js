...
$_mod.def("/marko-input-bug$1.0.0/src/ok-example/component", function(require, exports, module, __filename, __dirname) { module.exports = class {
  onCreate () {
    this.state = {
      text: ""
    };
...
$_mod.def("/marko-input-bug$1.0.0/src/ok-example/index.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.6.0 - DO NOT EDIT
"use strict";
...
var marko_template = module.exports = require('/marko$4.6.0/src/vdom'/*"marko/src/vdom"*/).t(),
    ...
    marko_componentType = marko_registerComponent("/marko-input-bug$1.0.0/src/ok-example/index.marko", function() {
      return module.exports;
    }),
    marko_component = require('/marko-input-bug$1.0.0/src/ok-example/component'/*"./component"*/),
...
$_mod.def("/marko-input-bug$1.0.0/src/ok-example/client", function(require, exports, module, __filename, __dirname) { const example = require('/marko-input-bug$1.0.0/src/ok-example/index.marko'/*"./index"*/);

example.renderSync().appendTo(document.body);

});
$_mod.run("/marko-input-bug$1.0.0/src/ok-example/client");